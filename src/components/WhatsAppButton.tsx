  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-16 top-1/2 -translate-y-1/2 w-max px-3 py-1.5 bg-foreground text-background text-sm font-medium rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-md">
          Chat with us
        </span>
      </Link>
    </div>

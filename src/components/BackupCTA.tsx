            ...
            <div className="lg:col-span-5 flex flex-col bg-background/30">
              <AnimatedSection delay={0.1} className="h-full flex flex-col">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <Link href="mailto:hello@vibeventure.in" className="px-6 py-6 group hover:bg-primary/5 transition-colors duration-300 flex flex-col items-center text-center justify-center relative overflow-hidden">

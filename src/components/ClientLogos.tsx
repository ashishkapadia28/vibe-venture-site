            ...
            <div className="flex flex-col items-center md:items-start gap-6">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-10">
                <div className="flex items-center grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-500">
                  <Image src="/client_logo/Arpanex_Primary_Dark.svg" alt="Arpanex" width={160} height={64} style={{ width: "auto" }} className="h-12 md:h-16 object-contain" />
                </div>
                <div className="flex items-center grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-500">
                  <Image src="/client_logo/Echovyn_Primary_logo.svg" alt="Echovyn" width={160} height={64} style={{ width: "auto" }} className="h-10 md:h-14 object-contain" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center md:items-start gap-6 relative">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-10">
                <div className="grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-500">
                  <Image src="/client_logo/Nyrly_Primary_logo.svg" alt="Nyrly" width={160} height={64} style={{ width: "auto" }} className="h-10 md:h-14 object-contain" />
                </div>
                <div className="grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-500">
                  <Image src="/client_logo/VediqCare_Primary_logo.svg" alt="VediqCare" width={160} height={64} style={{ width: "auto" }} className="h-10 md:h-14 object-contain" />
                </div>
              </div>
            </div>
